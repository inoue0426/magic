    ...
    try:
        if args.filetype == "csv":
            ...
            scdata = magic.mg.SCData.from_mtx(
                os.path.expanduser(args.data_file),
                os.path.expanduser(args.gene_name_file),
                normalize=False,
            )
        ...
        scdata.filter_scseq_data(
            filter_cell_min=args.mols_per_cell_min,
            filter_cell_max=args.mols_per_cell_max,
        )
        ...
        scdata.run_magic(
            ...
            random_pca=args.pca_non_random,
            t=args.t,
            k=args.k,
            ka=args.ka,
            epsilon=args.epsilon,
            rescale_percent=args.rescale,
        )
